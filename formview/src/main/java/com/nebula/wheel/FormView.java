...
public class FormView extends View {
    ...
    private void drawContent(Canvas canvas, float formHeight, float formWidth) {
        ...
        float contentX = mColumnWidth[0];
        float contentY = mPaint.getFontMetrics().bottom - mPaint.getFontMetrics().top - mPaint.getFontMetrics().descent;
    ...
    private void drawBeginColumn(Canvas canvas, float formHeight) {
        ...
        float contentX = 0;
        float contentY = mPaint.getFontMetrics().bottom - mPaint.getFontMetrics().descent - mPaint.getFontMetrics().top;
        float lenY = 0;
